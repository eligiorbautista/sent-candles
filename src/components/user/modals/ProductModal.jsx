...
import { useSocialMedia } from '../../../hooks/useSupabaseData.js';
                  ...
                  {product.availableScents && Array.isArray(product.availableScents) && product.availableScents.length > 0 ? (
                    <div className="flex flex-wrap gap-2">
                      {product.availableScents.map((scent, index) => (
                        <span
                          key={index}
                          className="text-sm font-medium px-3 py-1 rounded-full bg-amber-50 text-amber-800 border-amber-100 border"
                        >
                          {scent}
                        </span>
                      ))}
                    ...
                    product.scent && (
                      <span className="text-sm font-medium px-3 py-1 rounded-full bg-amber-50 text-amber-800 border-amber-100 border inline-block">
                        {product.scent}
                      </span>
                    )
                  )}
